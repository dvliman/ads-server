...
+---------------------------------------------------------------------------+
$Id: agency-edit.php 3145 2005-05-20 13:15:01Z andrew $
*/
...
if (isset($submit))
{
	...
	if (count($errormessage) == 0)
	{
		...
		else
		{
			...
			$update_sql = "UPDATE ".$phpAds_config['tbl_config']." SET language='".$agency['language']."', name='".$agency['name']."', admin_fullname='".$agency['contact']."', admin_email='".$agency['email']."' WHERE agencyid=$agencyid";
