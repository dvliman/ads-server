...
+---------------------------------------------------------------------------+
$Id: stats-campaign-sources.php 3145 2005-05-20 13:15:01Z andrew $
*/
...
{
	Header("Location: stats-campaign-affiliates.php?clientid=".$clientid."&campaignid=".$campaignid);
	exit;
}
...
if (!isset($listorder))
{
	if (isset($Session['prefs']['stats-campaign-sources.php']['listorder']))
		$listorder = $Session['prefs']['stats-campaign-sources.php']['listorder'];
	else
		$listorder = '';
}
...
{
	if (isset($Session['prefs']['stats-campaign-sources.php']['orderdirection']))
		$orderdirection = $Session['prefs']['stats-campaign-sources.php']['orderdirection'];
	else
		$orderdirection = '';
}

if (isset($Session['prefs']['stats-campaign-sources.php']['nodes']))
	$node_array = explode (",", $Session['prefs']['stats-campaign-sources.php']['nodes']);
else
	$node_array = array();
	...
	if (phpAds_getUserID() == phpAds_getCampaignParentClientID ($campaignid))
	{
		...
		while ($row = phpAds_dbFetchArray($res))
		{
			phpAds_PageContext (
				...
				"stats-campaign-sources.php?clientid=".$clientid."&campaignid=".$row['campaignid'],
...
$Session['prefs']['stats-campaign-sources.php']['listorder'] = $listorder;
$Session['prefs']['stats-campaign-sources.php']['orderdirection'] = $orderdirection;
$Session['prefs']['stats-campaign-sources.php']['nodes'] = implode (",", $node_array);
