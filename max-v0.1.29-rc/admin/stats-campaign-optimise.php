...
+---------------------------------------------------------------------------+
$Id: stats-campaign-optimise.php 3145 2005-05-20 13:15:01Z andrew $
*/
...
if ( ($total_arr['views'] > 0) || ($total_arr['clicks'] > 0) || ($total_arr['conversions'] > 0) )
{
	...
	// Views column header
	echo "\t\t\t\t\t<td align='".$phpAds_TextAlignRight."'>".phpAds_getColumnHeader($GLOBALS['strViews'], 'views', $link, $listorder, $orderdirection)."</td>\n";
