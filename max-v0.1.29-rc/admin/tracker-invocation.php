...
+---------------------------------------------------------------------------+
$Id: tracker-invocation.php 3145 2005-05-20 13:15:01Z andrew $
*/
...
{
	if ($invtype == "img")
		$tracker_code = phpAds_generateTrackerCode($trackerid);
	else if($invtype == "js")
		$tracker_code = phpAds_GenerateJavascriptTrackerCode($trackerid);

} else $tracker_code = phpAds_generateTrackerCode($trackerid);
