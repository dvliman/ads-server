    ...
    Version 0.1.29-rc
    ------------------------------------------------------------------------
    THIS IS RELEASE CANDIDATE SOFTWARE AND MAY NOT BE 
    ...
    In addition, as a special exception, Edd Dumbill <edd@usefulinc.com>
    ...
    Functionality:
    ------------------------------------------------------------------------
    For recent changes, please reference the CHANGELOG.
    ...
    Download:
    ------------------------------------------------------------------------
    You can get the latest version from http://max.awarez.net/.
    ...
    Vivian Girel, Ren̩ Friedrich <rene.friedrich@web.de> and many more.
