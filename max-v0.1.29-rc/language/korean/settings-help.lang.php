...
+---------------------------------------------------------------------------+
$Id: settings-help.lang.php 3145 2005-05-20 13:15:01Z andrew $
*/
...
$GLOBALS['phpAds_hlp_dbhost'] = "
        데이터베이스 서버에 사용할 호스트 이름을 지정합니다.".$phpAds_dbmsname." 
		";
		
$GLOBALS['phpAds_hlp_dbuser'] = $phpAds_productname."에서 데이터베이스 서버 ".$phpAds_dbmsname."에 액세스를 얻을 수 있는 사용자 이름을 지정합니다.";
...
$GLOBALS['phpAds_hlp_log_beacon'] = "
		...
		because a delivered banner doesn뭪 always have to be displayed on the screen. 
		";
...
$GLOBALS['phpAds_hlp_block_adviews'] = "
		...
		to 300 seconds, ".$phpAds_productname." will only log AdViews if the same banner isn뭪 already 
...
$GLOBALS['phpAds_hlp_block_adclicks'] = "
		...
		to 300 seconds, ".$phpAds_productname." will only log AdClicks if the visitor didn뭪 click on the same 
