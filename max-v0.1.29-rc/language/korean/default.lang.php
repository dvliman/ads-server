...
$GLOBALS['strExpandAll']			= "모두 보기(<u>E</u>)";
$GLOBALS['strCollapseAll']			= "모두 숨기기(<u>C</u>)";
$GLOBALS['strShowAll']				= "모두 보기";
...
$GLOBALS['strEnableCookies']			= $phpAds_productname."을 사용하려면 쿠키를 활성화해야합니다.";
...
$GLOBALS['strDuplicateClientName']		= "입력한 ID가 이미 있습니다. 다른 ID를 입력하세요.";
...
$GLOBALS['strCTR'] 				= "클릭율";
$GLOBALS['strTotalViews'] 			= "총 AdViews";
$GLOBALS['strTotalClicks'] 			= "총 AdClicks";
...
$GLOBALS['strMonth'] 				= array("1월","2월","3월","4월","5월","6월","7월", "8월", "9월", "10월", "11월", "12월");
$GLOBALS['strDayShortCuts'] 			= array("일","월","화","수","목","금","토");
$GLOBALS['strHour']				= "시";
...
$GLOBALS['strSendDeactivationWarning']  	= "캠페인이 중지되면 알립니다.";
...
$GLOBALS['strTotalCampaigns'] 			= "총 캠페인 수";
...
$GLOBALS['strBannersWithoutCampaign']		= "캠페인이 없는 배너(독립배너)";
$GLOBALS['strDeleteAllCampaigns']		= "모든 캠페인 삭제";
$GLOBALS['strCampaignStats']			= "캠페인 통계";
$GLOBALS['strCampaignProperties']		= "캠페인 등록정보";
$GLOBALS['strCampaignOverview']			= "캠페인 목록";
$GLOBALS['strCampaignHistory']			= "캠페인 기록";
$GLOBALS['strNoCampaigns']			= "현재 정의된 캠페인이 없습니다.";
$GLOBALS['strConfirmDeleteAllCampaigns']	= "해당 광고주의 모든 캠페인을 삭제합니까?";
$GLOBALS['strConfirmDeleteCampaign']		= "이 켐페인을 정말로 삭제합니까?";
$GLOBALS['strHideInactiveCampaigns']		= "운영하지 않는 캠페인 숨기기";
$GLOBALS['strInactiveCampaignsHidden']		= "캠페인이 숨겨져 있습니다.";


// Campaign properties
$GLOBALS['strDontExpire']			= "이 캠페인을 만료하지 않습니다.";
$GLOBALS['strActivateNow'] 			= "이 켐페인을 지금 활성화합니다.";
$GLOBALS['strLow']				= "낮음";
$GLOBALS['strHigh']				= "높음";
$GLOBALS['strExpirationDate']			= "만료일";
$GLOBALS['strActivationDate']			= "활성일";
$GLOBALS['strViewsPurchased'] 			= "AdView 남은 기간";
$GLOBALS['strClicksPurchased'] 			= "AdClick 남은 기간";
$GLOBALS['strCampaignWeight']			= "캠페인 가중치";
$GLOBALS['strHighPriority']			= "이 캠페인의 배너를 높은 우선 순위로 설정합니다.<br>이 옵션을 선택하면 phpAdsNew는 하루동안 지정된 횟수만큼 배너를 노출시키게 됩니다. 이와 같은 동작을 하려면 이미 축적된 통계가 필요합니다.";
$GLOBALS['strLowPriority']			= "이 캠페인의 배너를 낮은 우선 순위로 설정합니다.<br>이 옵션은 높은 우선 순위의 배너가 노출되지 않을 때 배너를 노출하기 위해 사용합니다. 노출 횟수를 지정할 수 없으며, 가중치를 통해서 낮은 우선 순위 배너들간의 비율만 설정할 수 있습니다.";
$GLOBALS['strTargetLimitAdviews']		= "일일 최대 AdView를 ";
...
$GLOBALS['strBannerHistory']			= "배너 기록";
...
$GLOBALS['strConfirmDeleteAllBanners']		= "해당 캠페인의 모든 배너를 삭제합니까?";
$GLOBALS['strConfirmResetBannerStats']		= "해당 배너에 대한 모든 통계를 삭제합니까?";
$GLOBALS['strShowParentCampaigns']		= "상위 캠페인 표시";
$GLOBALS['strHideParentCampaigns']		= "상위 캠페인 숨기기";
...
$GLOBALS['strAutoChangeHTML']			= "AdClick을 추적하기 위해 HTML을 수정합니다.";
$GLOBALS['strUploadOrKeep']			= "현재 이미지를 이용하거나<br> 다른 이미지를 업로드할<br> 수 있습니다.";
$GLOBALS['strNewBannerFile'] 			= "배너에 사용할 이미지를 선택하세요.";
...
$GLOBALS['strHardcodedLinks']			= "내장된 링크";
$GLOBALS['strConvertSWF']			= "<br>업로드한 플래시 파일에 URL을 포함시킬 수 있습니다. 업로드한 플래시 파일에 URL이 포함되어 있습니다. phpAdsNew는 플래시 파일에 포함된 URL을 변환하지 않으면 배너에 대한 AdClick 수를 추적할 수 없습니다. 다음은 플래시 파일에 포함된 URL 목록입니다. 이 URL을 변환하려면 <b>변환</b>을 클릭하고, 아니면 <b>취소</b>를 클릭하세요.Cancel</b>.<br><br>주의: <b>변환</b>을 클릭하면 업로드한 플래시 파일을 실제로 변경합니다.<br>원본 파일을 백업하십시오. 배너를 만드는데 사용한 플래시 파일의 버전에 상관없이 결과 파일은 플래시 4 파일로 생성합니다.<br><br>";
$GLOBALS['strCompressSWF']			= "보다 빠른 파일 전송을 위해 SWF 파일 압축";
$GLOBALS['strOverwriteSource']		= "소스 파라미터 덮어쓰기";
...
$GLOBALS['strTrackAdClicks']			= "AdClicks 추적";
...
$GLOBALS['strImpressionCapping']		= "동일한 사용자에게 배너를 노출하는 횟수:";


// Publisher
$GLOBALS['strAffiliate']			= "광고게시자";
$GLOBALS['strAffiliates']			= "광고게시자";
$GLOBALS['strAffiliatesAndZones']		= "광고게시자 & 영역";
$GLOBALS['strAddNewAffiliate']			= "새 광고게시자 추가";
$GLOBALS['strAddNewAffiliate_Key']			= "새 광고게시자 추가(<u>n</u>)";
$GLOBALS['strAddAffiliate']			= "광고게시자 생성";
$GLOBALS['strAffiliateProperties']		= "광고게시자 등록정보";
$GLOBALS['strAffiliateOverview']		= "광고게시자 목록";
$GLOBALS['strAffiliateHistory']			= "광고게시자 기록";
$GLOBALS['strZonesWithoutAffiliate']		= "광고게시자 미등록 영역";
$GLOBALS['strMoveToNewAffiliate']		= "새 광고게시자로 이동";
$GLOBALS['strNoAffiliates']			= "현재 정의된 광고게시자가 없습니다.";
$GLOBALS['strConfirmDeleteAffiliate']		= "해당 광고게시자를 삭제합니까?";
$GLOBALS['strMakePublisherPublic']		= "광고게시자에게 해당하는 영역을 공개합니다.";


// Publisher (properties)
$GLOBALS['strWebsite']				= "웹 사이트";
...
$GLOBALS['strZoneNoDelivery']			= "이 영역에서 어떤 배너도 전달할 수 없습니다...";
$GLOBALS['strZoneStopDelivery']			= "연결유지를 중지하고 배너를 표시하지 않습니다.";
$GLOBALS['strZoneOtherZone']			= "선택된 영역을 대신 표시합니다.";
$GLOBALS['strZoneUseKeywords']			= "아래에 입력된 키워드를 사용해서 배너를 선택하세요.";
$GLOBALS['strZoneAppend']			= "이 영역에 연결된 배너에 팝업이나 격자 배너 호출 코드를 항상 추가합니다.";
$GLOBALS['strAppendSettings']			= "배너 첨부 설정";
$GLOBALS['strZonePrependHTML']			= "이 영역에 표시된 텍스트 광고 앞에 HTML 코드를 추가합니다.";
$GLOBALS['strZoneAppendHTML']			= "이 영역에 표시된 텍스트 광고 뒤에 HTML 코드를 추가합니다.";


// Zone probability
$GLOBALS['strZoneProbListChain']		= "선택한 영역에 연결된 배너는 모두 널(null) 우선순위입니다. 영역 연결은 다음과 같습니다.:";
...
$GLOBALS['strLinkedBannersOverview']		= "연결된 배너 목록";
$GLOBALS['strLinkedBannerHistory']		= "연결된 배너 기록";
...
$GLOBALS['strNoCampaignsToLink']		= "현재 이 영역에 연결할 켐페인이 없습니다.";
$GLOBALS['strNoZonesToLinkToCampaign']  	= "현재 이 영역에 연결된 켐페인이 없습니다.";
...
// Statistics
$GLOBALS['strStats'] 				= "통계";
$GLOBALS['strNoStats']				= "현재 이용할 수 있는 통계가 없습니다.";
$GLOBALS['strConfirmResetStats']		= "모든 통계를 삭제하시겠습니까?";
$GLOBALS['strGlobalHistory']			= "전체 기록";
$GLOBALS['strDailyHistory']			= "일일 기록";
$GLOBALS['strDailyStats'] 			= "일일 통계";
...
$GLOBALS['strSelectSource']			= "조회할 소스를 선택하세요:";
...
// Expiration
$GLOBALS['strExpired']				= "만료됨";
$GLOBALS['strExpiration'] 			= "만료일";
$GLOBALS['strNoExpiration'] 			= "만료일 설정없음";
$GLOBALS['strEstimated'] 			= "예상 만료일";
...
$GLOBALS['strNoActionsLogged']			= "기록된 내용이 없습니다.";


// Code generation
$GLOBALS['strGenerateBannercode']		= "배너 코드 생성";
$GLOBALS['strChooseInvocationType']		= "호출할 배너 종류를 선택하세요.";
$GLOBALS['strGenerate']				= "생성하기";
$GLOBALS['strParameters']			= "파라미터";
...
$GLOBALS['strLogErrorClicks'] 			= "[phpAds] 데이터베이스에서 AdClick을 가져오는 동안 오류가 발생했습니다.";
$GLOBALS['strErrorViews'] 			= "뷰 횟수를 입력하거나 제한하지 않음 상자를 체크해야합니다!";
$GLOBALS['strErrorNegViews'] 			= "음수는 사용할 수 없습니다.";
$GLOBALS['strErrorClicks'] 			= "클릭 횟수를 입력하거나 제한하지 않음 상자를 체크해야합니다!";
$GLOBALS['strErrorNegClicks'] 			= "부정한 클릭(negative click)은 허용되지 않습니다.";
...
$GLOBALS['strErrorUploadBasedir']		= "업로드된 파일에 액세스할 수 없습니다. 안전 모드 또는 open_basedir 제한 때문일 수 있습니다.";
$GLOBALS['strErrorUploadUnknown']		= "알 수 없는 이유로 업로드된 파일에 액세스할 수 없습니다. PHP 설정을 확인하십시오.";
$GLOBALS['strErrorStoreLocal']			= "로컬 디렉터리에 배너를 저장하는 동안 오류가 발생했습니다. 로컬 디렉터리 경로 설정이 잘못되었을 수 있습니다.";
$GLOBALS['strErrorStoreFTP']			= "FTP 서버에 배너를 업로드하는 동안 오류가 발생했습니다. 서버를 이용할 수 없거나 FTP 서버 설정이 잘못되었을 수 있습니다.";
...
$GLOBALS['strMailBannerStats'] 			= "{clientname}의 배너 통계는 다음과 같습니다.";
$GLOBALS['strMailFooter'] 			= "Regards,\n   {adminfullname}";
$GLOBALS['strMailClientDeactivated'] 		= "다음 배너는 다음 이유로 이용할 수 없습니다.";
$GLOBALS['strMailNothingLeft'] 			= "웹 사이트를 계속 홍보하려면 담당자에게 문의하십시오.";
$GLOBALS['strClientDeactivated']		= "이 캠페인은 현재 다음과 같은 이유로 운영하지 않습니다.";
$GLOBALS['strBeforeActivate']			= "아직 시작일이 아닙니다.";
$GLOBALS['strAfterExpire']			= "만기일입니다.";
$GLOBALS['strNoMoreClicks']			= "남아있는 AdClicks이 없습니다.";
$GLOBALS['strNoMoreViews']			= "남아있는 AdViews이 없습니다.";
$GLOBALS['strWarnClientTxt']			= "배너에 남아있는 AdClciks 또는 AdViews은 {limit}입니다. \n남아있는 AdCliks나 AdViews가 없을 때 배너를 운영 중지합니다. ";
$GLOBALS['strViewsClicksLow']			= "AdViews/AdClicks이 낮습니다.";
$GLOBALS['strNoViewLoggedInInterval']   	= "이 기간 동안의 보고서에 기록된 AdViews가 없습니다.";
$GLOBALS['strNoClickLoggedInInterval']  	= "이 기간 동안의 보고서에 기록된 AdClicks이 없습니다.";
$GLOBALS['strMailReportPeriod']			= "이 보고서에는 {startdate}에서 {enddate}까지의 통계를 포함하고 있습니다.";
$GLOBALS['strMailReportPeriodAll']		= "이 보고서에는 {enddate}까지의 통계를 포함하고 있습니다.";
$GLOBALS['strNoStatsForCampaign'] 		= "이 캠페인에서 이용할 수 있는 통계가 없습니다.";
