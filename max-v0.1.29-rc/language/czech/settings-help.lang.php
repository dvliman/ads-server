...
+---------------------------------------------------------------------------+
$Id: settings-help.lang.php 1167 2004-12-17 17:07:28Z andrew $
*/
...
$GLOBALS['phpAds_hlp_block_adconversions'] = "
		...
		to 300 seconds, ".$phpAds_productname." will only log AdConversions if the visitor didn�t load the same
