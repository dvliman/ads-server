...
$GLOBALS['strNavigation'] 					= "Navegaci&oacute;n";
...
$GLOBALS['strInvocationcode']				= "C&oacute;digo";
$GLOBALS['strBasicInformation'] 			= "Informaci&oacute;n b&aacute;sica";
$GLOBALS['strContractInformation'] 			= "Contraer informaci&oacute;n";
...
$GLOBALS['strCustom']						= "Com&uacute;n";
...
$GLOBALS['strDaysLeft'] 					= "D&iacute;as restantes";
...
$GLOBALS['strSize']							= "Tama&ntilde;o";
$GLOBALS['strWidth'] 						= "Ancho";
$GLOBALS['strHeight'] 						= "Alto";
$GLOBALS['strURL2']							= "URL";
$GLOBALS['strTarget']						= "Target";
$GLOBALS['strLanguage'] 					= "Idioma";
$GLOBALS['strDescription'] 					= "Descripci&oacute;n";
$GLOBALS['strID']				 			= "ID";


// Login & Permissions
$GLOBALS['strAuthentification'] 			= "Autenticaci&oacute;n";
...
$GLOBALS['strClickCredits'] 				= "Cr&eacute;ditos de Clicks";


// Time and date related
$GLOBALS['strDate'] 						= "Fecha";
$GLOBALS['strToday'] 						= "Hoy";
$GLOBALS['strDay']							= "D&iacute;a";
$GLOBALS['strDays']							= "D&iacute;as";
$GLOBALS['strLast7Days']					= "&Uacute;ltimos 7 d&iacute;as";
...
$GLOBALS['strClientsAndCampaigns']			= "Anunciantes & Campa&ntilde;as";
...
$GLOBALS['strConfirmResetClientStats']		= "Est&aacute; seguro de querer borrar todas las estad&iacute;sticas de este Anunciante?";
...
$GLOBALS['strNoDaysBetweenReports']			= "Cant. de d&iacute;as entre reportes";
$GLOBALS['strSendDeactivationWarning']  	= "Enviar un Alerta cuando una campa&ntilde;a sea desactivada";
...
// Campaign
$GLOBALS['strCampaign']						= "Campa&ntilde;a";
$GLOBALS['strCampaigns']					= "Campa&ntilde;as";
$GLOBALS['strTotalCampaigns'] 				= "Total de Campa&ntilde;as";
$GLOBALS['strActiveCampaigns'] 				= "Campa&ntilde;as Activas";
$GLOBALS['strAddCampaign'] 					= "Agregar Nueva Campa&ntilde;a";
$GLOBALS['strCreateNewCampaign']			= "Crear Nueva Campa&ntilde;a";
$GLOBALS['strModifyCampaign']				= "Modificar Campa&ntilde;a";
$GLOBALS['strMoveToNewCampaign']			= "Mover a una nueva Campa&ntilde;a";
$GLOBALS['strBannersWithoutCampaign']		= "Banners sin una Campa&ntilde;a";
$GLOBALS['strDeleteAllCampaigns']			= "Borrar todas las Campa&ntilde;as";
$GLOBALS['strCampaignStats']				= "Estad&iacute;sticas de la Campa&ntilde;a";
$GLOBALS['strCampaignProperties']			= "Propiedades de Campa&ntilde;a";
$GLOBALS['strCampaignOverview']				= "Resumen de Campa&ntilde;a";
$GLOBALS['strCampaignHistory']				= "Historial de Campa&ntilde;a";
...
$GLOBALS['strConfirmDeleteCampaign']		= "Est&aacute; de querer borrar esta campa&ntilde;a?";
$GLOBALS['strHideInactiveCampaigns']		= "Ocultar campa&ntilde;as inactivas.";
$GLOBALS['strInactiveCampaignsHidden']		= "campa&ntilde;a(s) inactivas ocultas";
...
$GLOBALS['strActivationDate']				= "Fecha de activaci&oacute;n";
$GLOBALS['strViewsPurchased'] 				= "Impresiones restantes";
$GLOBALS['strClicksPurchased'] 				= "Clicks restantes";
$GLOBALS['strCampaignWeight']				= "Peso de Campa&ntilde;a";
$GLOBALS['strHighPriority']					= "Mostrar los banners con Alta Prioridad en esta campa&ntilde;a.<br>
											Si Ud. usa esta opci&oacute;n el programa tratar&aacute; de
											distribuir el nr. de Impresiones uniformemente durante el curso
											del d&iacute;a.";
$GLOBALS['strLowPriority']					= "Mostrar los banner con Baja Prioridad en esta campa&ntilde;a.<br>
											Esta campa&ntilde;a es usada para mostrar las Impresiones
											restantes que no son usadas por las campa&ntilde;a de Alta
											Prioridad.";
$GLOBALS['strTargetLimitAdviews']			= "Limitar el n&uacute;mero de Impresiones a";
$GLOBALS['strTargetPerDay']					= "por d&iacute;a.";
$GLOBALS['strPriorityAutoTargeting']		= "Distribuir las Impresiones restantes uniformemente durante los d&iacute;as restantes.";
...
$GLOBALS['strBannerNoStats'] 				= "No hay estad&iacute;sticas disponibles para este banner.";
$GLOBALS['strNoBanners']					= "No hay banners definidos.";
$GLOBALS['strConfirmDeleteBanner']			= "Est&aacute; seguro de querer borrar este banner?";
$GLOBALS['strConfirmDeleteAllBanners']		= "Est&aacute; seguro de querer borrar todos los banners de esta campa&ntilde;a?";
$GLOBALS['strConfirmResetBannerStats']		= "Est&aacute; seguro de querer borrar todas las estad&iacute;sticas de este banner?";
...
$GLOBALS['strConvertSWF']					= "<br>El archivo Flash que acaba de subir contiene hard-coded urls. El programa no podr&aacute; ".
											  "rastrear el nr. de Clicks para este banner si Ud. no convierte las ".
											  "hard-coded urls. A continuaci&oacute;n encontrar&aacute; una lista de todas las urls correspodnientes al archivo Flash. ".
											  ...
											  "Note que si clickea <b>Convertir</b>, el archivo Flash ".
									  		  "ser&aacute; alterado fisicamente. <br>Conserve una copia de seguridad del ".
											  "archivo original. Sin importar en que version fue creado el banner, el archivo ".
											  "resultante podr&aacute; ser visto correctamente con \"Flash 4 player\" (o posterior).<br><br>";
$GLOBALS['strCompressSWF']					= "Comprimir el archivo SWF para bajarlo m&aacute;s r&aacute;pidamente (requiere \"Flash 6 player\")";


// Banner (network)
$GLOBALS['strBannerNetwork']				= "plantilla HTML";
$GLOBALS['strChooseNetwork']				= "Elija la plantilla que quiera usar";
$GLOBALS['strMoreInformation']				= "Mas informaci&oacute;n...";
...
$GLOBALS['strWeekDay'] 						= "D&iacute;a de semana";
...
$GLOBALS['strConfirmDeleteAffiliate']		= "Est&aacute; seguro de querer borrar este Afiliado?";
$GLOBALS['strMakePublisherPublic']			= "Hacer p&uacute;blicas las zonas de este Afiliado";
...
$GLOBALS['strConfirmDeleteZone']			= "Est&aacute; seguro de querer borrar esta zona?";
$GLOBALS['strZoneType']						= "Tipo de zona";
$GLOBALS['strBannerButtonRectangle']		= "Banner, Bot&oacute;n o Rect&aacute;ngulo";
...
$GLOBALS['strZonePrependHTML']				= "Desagregar siempre el c&oacute;digo HTML al texto publicitario mostrado por esta zona";
$GLOBALS['strZoneAppendHTML']				= "Agregar siempre el c&oacute;digo HTML al texto publicitario mostrado por esta zona";


// Linked banners/campaigns
$GLOBALS['strSelectZoneType']				= "Elija el tipo de linkeo de banners";
$GLOBALS['strBannerSelection']				= "Selecci&oacute;n de banner";
$GLOBALS['strCampaignSelection']			= "Selecci&oacute;n de Campa&ntilde;a";
...
$GLOBALS['strNoCampaignsToLink']			= "No hay campa&ntilde;as disponibles para linkear a esta zona";
$GLOBALS['strNoZonesToLinkToCampaign']  	= "No hay zonas disponibles donde linkear esta campa&ntilde;a";
$GLOBALS['strSelectBannerToLink']			= "Seleccione el banner que desea linkear a esta zona:";
$GLOBALS['strSelectCampaignToLink']			= "Seleccione la campa&ntilde; que desea linkear a esta zona:";


// Statistics
$GLOBALS['strStats'] 						= "Estad&iacute;sticas";
$GLOBALS['strNoStats']						= "No hay estad&iacute;sticas disponibles";
$GLOBALS['strConfirmResetStats']			= "Est&aacute seguro de querer borrar todas las estad&iacute;sticas?";
$GLOBALS['strGlobalHistory']				= "Historial Global";
$GLOBALS['strDailyHistory']					= "Historial diario";
$GLOBALS['strDailyStats'] 					= "Estad&iacute;sticas diarias";
$GLOBALS['strWeeklyHistory']				= "Historial semanal";
$GLOBALS['strMonthlyHistory']				= "Historial mensual";
$GLOBALS['strCreditStats'] 					= "Estad&iacute;sticas de cr&eacute;dito";
$GLOBALS['strDetailStats'] 					= "Estad&iacute;sticas detalladas";
$GLOBALS['strTotalThisPeriod']				= "Total del per&iacute;odo";
$GLOBALS['strAverageThisPeriod']			= "Promedio del per&iacute;odo";
$GLOBALS['strDistribution']					= "Distribuci&oacute;n";
$GLOBALS['strResetStats'] 					= "Resetear Estad&iacute;sticas";
$GLOBALS['strSourceStats']					= "Estad&iacute;sticas de fuente";
...
$GLOBALS['strAction']						= "Acci&oacute;n";
$GLOBALS['strNoActionsLogged']				= "No hay acciones logueadas";


// Code generation
$GLOBALS['strGenerateBannercode']			= "Generar c&oacute;digo de banner";
$GLOBALS['strChooseInvocationType']			= "Elija el tipo de invocaci&oacute;n del banner";
$GLOBALS['strGenerate']						= "Generar";
$GLOBALS['strParameters']					= "Parametros";
$GLOBALS['strFrameSize']					= "Tama&ntilde;o del Frame";
...
$GLOBALS['strErrorNegViews'] 				= "No est&aacute;n permitidas Impresiones negativas !";
$GLOBALS['strErrorClicks'] 					= "Debe ingresar el numero de Clicks o seleccionar la casilla de Ilimitadas !";
$GLOBALS['strErrorNegClicks'] 				= "No est&aacute;n permitidos los Clicks negativos";
...
$GLOBALS['strErrorUploadUnknown']		= "No se puede acceder al archivo recibido y se desconoce la raz&oacute;n. Chequee su configuraci&oacute;n de PHP";
$GLOBALS['strErrorStoreLocal']			= "Ha ocurrido un error mientras se intentaba guardar el banner en el directorio local. Probablemente se deba a una mala configuraci&oacute;n del directorio local";
$GLOBALS['strErrorStoreFTP']			= "Ha ocurrido un error mientras se intentaba subir el banner al servidor FTP. Puede deberse a que el servidor FTP no se encuentra disponible o bien a una mala configuraci&oacute;n del mismo";
...
$GLOBALS['strMailBannerStats'] 				= "A continuaci&oacute;n encontrar&aacute; las estad&iacute;sticas de banners de {clientname}:";
...
$GLOBALS['strClientDeactivated']			= "Esta campa&ntilde;a no se encuentra activada porque";
$GLOBALS['strBeforeActivate']				= "la fecha de activaci&oacute;n a&uacute;n no ha sido alcanzada";
...
$GLOBALS['strWarnClientTxt']				= "Sus Clicks o Impresiones estan llegando a {limit}. \nSus banners ser&aacute;n deshabilitados cuando ya no disponga de Clicks o Impresiones. ";
$GLOBALS['strViewsClicksLow']				= "Dispone de pocos Clicks/Impresiones";
$GLOBALS['strNoViewLoggedInInterval']   	= "Ninguna Impresion se ha detectado hasta la confecci&oacute;n de este reporte";
$GLOBALS['strNoClickLoggedInInterval']  	= "Ningun Click se ha detectado hasta la confecci&oacute;n de este reporte";
$GLOBALS['strMailReportPeriod']				= "Este reporte incluye estad&iacute;sticas desde {startdate} hasta {enddate}.";
$GLOBALS['strMailReportPeriodAll']			= "Este reporte incluye todas las estad&iacute;sticas hasta {enddate}.";
$GLOBALS['strNoStatsForCampaign'] 			= "No hay estad&iacute;sticas disponibles para esta campa&ntilde;a";
...
$GLOBALS['strAdminSettings']				= "Propiedades de Administraci&oacute;n";
