...
$GLOBALS['phpAds_hlp_log_beacon'] = "
		...
		".$phpAds_productname."��ʹ�ô��źŵ�4��������ʾ�Ĵ���. 
		�����ر��˴�ѡ��,������ʾ�����ڷ��͵�ʱ�����, ����������ȫ׼ȷ, 
		��Ϊһ���Ѿ����͵Ĺ�治һ��������ʾ����Ļ��. 
		";
...
$GLOBALS['phpAds_hlp_log_iponly'] = "
		��������ߵ�������ռ����ݿ�ܶ�Ŀռ�.
		��������ô�ѡ��,".$phpAds_productname."�����Ǳ���������Ϣ,
		���ǽ��ռ�ÿռ��ٵ�IP��ַ��Ϣ.
		���������ṩ��������".$phpAds_productname."��������,��ѡ�����.
		��Ϊ����������Ǽ�¼IP��ַ.
		";
...
$GLOBALS['phpAds_hlp_warn_client'] = "
        ���һ��ͻ���ĳ����Ŀֻʣ�����޵ķ�����͵�����".$phpAds_productname."�ܹ��������ʼ�4���ѿͻ�.��ѡ��ȱʡ�Ǵ򿪵�.
		";
		
$GLOBALS['phpAds_hlp_qmail_patch'] = "
		qmail��һЩ�汾��Ϊ�ܵ�һ��bug��Ӱ��,���".$phpAds_productname."���͵ĵ����ʼ����ʼ�������������ʾ�ʼ�ͷ.
		��������ô�ѡ��,".$phpAds_productname."��ʹ��qmail���ݸ�ʽ4���͵����ʼ�.
		";
