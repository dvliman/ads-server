...
// Other
$GLOBALS['strCopyToClipboard']		= "Copiar para mem&oacute;ria";
...
$GLOBALS['strInvocationWhat']			= "Selecção de Anúncio";
$GLOBALS['strInvocationClientID']		= "Anunciante ou campanha";
$GLOBALS['strInvocationTarget']			= "<i>Frame</i> destino";
$GLOBALS['strInvocationSource']			= "Fonte";
$GLOBALS['strInvocationWithText']		= "Mostrar texto abaixo do anúncio";
$GLOBALS['strInvocationDontShowAgain']	= "Não repetir o anúncio na mesma página";
$GLOBALS['strInvocationTemplate'] 		= "Guardar o anúncio numa variável para que possa ser usado num <i>template</i>";


// Iframe
$GLOBALS['strIFrameRefreshAfter']		= "Renovar após";
$GLOBALS['strIframeResizeToBanner']		= "Redimensionar <i>iframe</i> para as dimensões do anúncio";
$GLOBALS['strIframeMakeTransparent']	= "Tornar a <i>iframe</i> transparente";
$GLOBALS['strIframeIncludeNetscape4']	= "Incluir <i>Netscape 4 compatible ilayer</i>";
...
$GLOBALS['strPopUpCreateInstance']		= "Criar instância quando o pop-up é criado";
$GLOBALS['strPopUpImmediately']			= "Immediatamente";
$GLOBALS['strPopUpOnClose']				= "Quando a página é encerrada";
$GLOBALS['strPopUpAfterSec']			= "Após";
$GLOBALS['strAutoCloseAfter']			= "Automaticamente encerrada após";
$GLOBALS['strPopUpTop']					= "Posição Inicial (topo)";
$GLOBALS['strPopUpLeft']				= "Posição Inicial (esquerda)";
...
$GLOBALS['strAutoCollapseAfter']		= "Desaparece automáticamente após";
