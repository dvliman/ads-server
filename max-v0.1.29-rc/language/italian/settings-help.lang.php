...
$GLOBALS['phpAds_hlp_log_beacon'] = "
		...
		questo beacon per contare il numero di visualizzazioni del banner. Se viceversa non � attiva, le
...
$GLOBALS['phpAds_hlp_log_source'] = "
		Se utilizzi il parametro sorgente nel codice di invocazione, &egrave; possibile memorizzare anche
		questa informazione nel database. In questo modo sar&agrave; possibile vedere statistiche
		suddivise per parametro sorgente. Se il paramentro sorgente non viene utilizzato, si pu&ograve;
		tranquillamente disabilitare questa opzione.
		";
...
$GLOBALS['phpAds_hlp_log_hostname'] = "
		Abilitando questa opzione, verranno memorizzati nelle statistiche lo hostname o l'indirizzo IP di
		ciascun visitatore. Tramite queste informazioni, sar&agrave; possibile vedere quali host
		visualizzano pi&ugrave; banner. Questa opzione &egrave; disponibile solo utilizzando le statistiche estese.
		";
		
$GLOBALS['phpAds_hlp_log_iponly'] = "
		Memorizzare lo hostname dei visitatori occupa parecchio spazio nel database. Abilitando questa opzione
		".$phpAds_productname." memorizzer&agrave; comunque un'informazione sull'host, ma solo l'indirizzo IP,
		occupando cos&igrave; meno spazio. Questa opzione non &egrave; disponibile se l'hostname non &egrave;
		fornito dal server o da ".$phpAds_productname.", poich&eacute; in tal caso sar&agrave; sempre memorizzato
		l'indirizzo IP.
		";
