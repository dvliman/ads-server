...
// German
// Invocation Types
$GLOBALS['strInvocationRemote']		= "Normaler Bannercode (Remote)";
$GLOBALS['strInvocationJS']			= "Bannercode für JavaScript";
...
$GLOBALS['strInvocationWhat']			= "Bannerauswahl";
$GLOBALS['strInvocationClientID']		= "Inserent oder Kampagne";
$GLOBALS['strInvocationTarget']			= "Zielfenster (target frame)";
$GLOBALS['strInvocationSource']			= "Quelle";
$GLOBALS['strInvocationWithText']		= "Textanzeige unterhalb Banner";
$GLOBALS['strInvocationDontShowAgain']		= "Banner auf derselben Seite nicht mehrfach anzeigen";
$GLOBALS['strInvocationDontShowAgainCampaign']		= "Banner derselben Kampagne nicht mehrfach auf derselben Seite anzeigen";
$GLOBALS['strInvocationTemplate'] 		= "Um Templates nutzen zu können, Banner in einer Variablen speichern";
...
// PopUp
$GLOBALS['strPopUpStyle']			= "PopUp Type";
