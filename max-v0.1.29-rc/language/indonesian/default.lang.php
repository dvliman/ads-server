...
$GLOBALS['strCollectedAll']					= "Kumpulan seluruh statistik";
$GLOBALS['strCollectedToday']					= "Statistik hari ini saja";
$GLOBALS['strCollected7Days']					= "Statistik 7 hari terakhir saja";
$GLOBALS['strCollectedMonth']					= "Statistik bulan ini saja";
...
$GLOBALS['strTotalClicks'] 					= "Jumlah AdClicks";
$GLOBALS['strViewCredits'] 					= "Kredit AdView";
$GLOBALS['strClickCredits'] 					= "Kredit AdClick";
...
$GLOBALS['strMonth'] 						= array("Januari","Februari","Maret","April","Mei","Juni","Juli", "Agustus", "September", "Oktober", "November", "Desember");
$GLOBALS['strDayShortCuts'] 					= array("Min","Sen","Sel","Rab","Kam","Jum","Sab");
$GLOBALS['strHour']						= "Jam";
...
$GLOBALS['strExpirationDate']					= "Masa berlaku";
$GLOBALS['strActivationDate']					= "Tanggal pengaktifan";
$GLOBALS['strViewsPurchased'] 					= "AdViews tersisa";
$GLOBALS['strClicksPurchased'] 					= "AdClicks tersisa";
$GLOBALS['strCampaignWeight']					= "Bobot Kampanye";
$GLOBALS['strHighPriority']					= "Tampilkan banner dengan prioritas yang tinggi dalam kampanye ini.<br>Bila Anda mengunakan pilihan ini, phpAdsNew akan membagikan jumlah AdViews secara rata dalam satu hari.";
...
$GLOBALS['strShowParentCampaigns']				= "Tampilkan kampanye pusat";
$GLOBALS['strHideParentCampaigns']				= "Sembunyikan kampanye pusat";
...
$GLOBALS['strAutoChangeHTML']					= "Ubah HTML untuk memungkinkan tracking AdClicks";
...
$GLOBALS['strConvertSWF']					= "<br>File Flash yang di-upload berisi URL yang hard-coded. phpAdsNew tidak bisa mencatat jumlah AdClicks untuk banner tersebut sampai hard-coded URL dirubah. Dibawah ini terdaftar seluruh URL yang berada dalam file Flash tersebut. Bila Anda ingin merubah URL silakan klik <b>Convert</b>, bilak tidak klik <b>Cancel</b>.<br><br>Perhatian: Bila Anda klik<b>Convert</b> file Flash yang baru di-upload akan dirubah secara fisik. <br>Mohon simpan backup dari file asli. Dengan versi apapun banner tersebut dibuat, file yang didapatkan akan membutuhkan Player Flash 4 (atau versi lebih tinggi) untuk ditampilkan secara benar.<br><br>";
...
$GLOBALS['strDifferentFrom']					= "lain daripada";
$GLOBALS['strLaterThan']					= "lebih lambat dari";
$GLOBALS['strLaterThanOrEqual']					= "lebih lambat dari atau sama dengan";
$GLOBALS['strEarlierThan']					= "lebih cepat dari";
$GLOBALS['strEarlierThanOrEqual']				= "lebih cepat dari atau sama dengan";
...
$GLOBALS['strContinent'] 					= "Benua";
$GLOBALS['strUSState']						= "Propinsi AS";
$GLOBALS['strReferer'] 						= "Halaman berkenaan";
$GLOBALS['strDeliveryLimitations']				= "Pembatasan Penyampaian";
$GLOBALS['strDeliveryCapping']					= "Capping Penyampaian";
$GLOBALS['strTimeCapping']					= "Bila banner ini telah disampaikan, jangan menampilkannya ulang selama:";
$GLOBALS['strImpressionCapping']				= "Jangan tampilkan banner ini di layar pengunjung yang sama lebih dari:";


// Publisher
$GLOBALS['strAffiliate']					= "Penerbit";
$GLOBALS['strAffiliates']					= "Penerbit";
$GLOBALS['strAffiliatesAndZones']				= "Penerbit & Zona";
$GLOBALS['strAddNewAffiliate']					= "Tambah Penerbit baru";
$GLOBALS['strAddNewAffiliate_Key']				= "Tambah Penerbit  <u>b</u>aru";
$GLOBALS['strAddAffiliate']					= "Buat Penerbit";
$GLOBALS['strAffiliateProperties']				= "Properties Penerbit";
...
$GLOBALS['strAllowAffiliateModifyInfo'] 			= "Izinkan pengguna ini untuk mengubah penyetelan yang dimiliki";
...
$GLOBALS['strSelectZoneType']					= "Silakan pilih jenis dari linking banner";
$GLOBALS['strBannerSelection']					= "Pilihan Banner";
$GLOBALS['strCampaignSelection']				= "Pilihan Kampanye";
...
$GLOBALS['strConfirmResetStats']				= "Apakah benar Anda ingin hapus semua statistik yang ada?";
...
$GLOBALS['strDistribution']					= "Distribusi";
...
$GLOBALS['strAction']						= "Tindakan";
$GLOBALS['strNoActionsLogged']					= "Tidak ada tindakan yang di-log";


// Code generation
$GLOBALS['strGenerateBannercode']				= "Pilihan langsung";
...
$GLOBALS['strErrorNegViews'] 					= "View yang negatif tidak diperbolehkan";
$GLOBALS['strErrorClicks'] 					= "Anda harus mengisi jumlah Clicks atau pilih kotak <i>Unlimited</i> !";
$GLOBALS['strErrorNegClicks'] 					= "Clicks yang negatif tidak diperbolehkan";
...
$GLOBALS['strErrorDBNoDataPlain']				= "Sehubungan ada masalah pada database, ".$phpAds_productname." gagal mengambil atau menyimpan data. ";
$GLOBALS['strErrorDBNoDataSerious']				= "Sehubungan ada masalah yang serius pada database, ".$phpAds_productname." gagal mengambil data. ";
...
$GLOBALS['strErrorDBSubmitBug']					= "Bila masalah ini bisa diulang-ulang, ada kemungkinan hal ini disebabkan oleh sebuah bug pada ".$phpAds_productname.". Mohon laporkan informasi berikut ini kepada pencipta dari program ".$phpAds_productname.". Mohon berikan deskripsi tentang sejarah masalah ini secara rinci.";
$GLOBALS['strMaintenanceNotActive']				= "Skript Pemeliharaan <i>(Maintenance)</i> tidak dijalankan dalam waktu 24 jam terakhir. \\nUntuk menjaminkan ".$phpAds_productname." berfungsi semestinya, skript Pemeliharaan perlu dijalankan \\setiap jam. \\n\\nMohon belajari <i>Administrator Guide</i> untuk informasi lebih lanjut \\ntentang caranya untuk mengkonfigurasi skript Pemeliharaan.";


// E-mail
$GLOBALS['strMailSubject'] 					= "Laporan untuk Pemasang Iklan";
$GLOBALS['strAdReportSent']					= "Laporan untuk Pemasang Iklan telah dikirim";
$GLOBALS['strMailSubjectDeleted'] 				= "Banner yang dihentikan";
$GLOBALS['strMailHeader'] 					= "Dengan Hormat, {contact},\n";
$GLOBALS['strMailBannerStats'] 					= "Dengan E-mail ini kami mengirimkan data statistik pemasangan iklan banner untuk {clientname}.";
$GLOBALS['strMailFooter'] 					= "Hormat Kami,\n{adminfullname}";
$GLOBALS['strMailClientDeactivated'] 				= "Banner berikut dihentikan berdasarkan";
...
$GLOBALS['strClientDeactivated']				= "Kampanye yang bersangkutan pada saat ini tidak aktif sehubungan";
$GLOBALS['strBeforeActivate']					= "belum saatnya tanggal aktivasi";
$GLOBALS['strAfterExpire']					= "masa berlakunya sudah habis";
$GLOBALS['strNoMoreClicks']					= "tidak ada AdClicks yang tersisa";
$GLOBALS['strNoMoreViews']					= "tidak ada AdViews yang tersisa";
$GLOBALS['strWeightIsNull']					= "bobot ditetapkan pada nol";
$GLOBALS['strWarnClientTxt']					= "AdClicks atau AdView yang tersisa untuk banner Anda mendekati batas {limit}. \nTampilan banner Anda akan dihentikan bilamana tidak ada AdClicks atau AdViews yang tersisa. ";
$GLOBALS['strViewsClicksLow']					= "sisa AdViews/AdClicks tinggal sedikit";
$GLOBALS['strNoViewLoggedInInterval']   			= "Tidak ada AdViews yang tercatat sejak pengiriman laporan terakhir";
$GLOBALS['strNoClickLoggedInInterval']  			= "Tidak ada AdClicks yang tercatat sejak pengiriman laporan terakhir";
$GLOBALS['strMailReportPeriod']					= "Laporan ini berisi statistik tentang performa banner Anda di situs kami terhitung dari tanggal {startdate} s/d. tanggal {enddate}.";
$GLOBALS['strMailReportPeriodAll']				= "Laporan ini berisi seluruh statistik tentang performa banner Anda di situs kami terhitung s/d. tanggal {enddate}.";
$GLOBALS['strNoStatsForCampaign'] 				= "Tidak ada statistik yang tersedia untuk kampanye ini ";
...
// Settings
$GLOBALS['strSettings'] 					= "Penyetelan";
$GLOBALS['strGeneralSettings']					= "Penyetelan Umum";
$GLOBALS['strMainSettings']					= "Penyetelan Pusat";
