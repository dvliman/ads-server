...
$GLOBALS['strWarningTrackVars']			= "Opcja konfiguracyjna PHP variable track_vars musi by� w��czona.";
...
$GLOBALS['strUseConditionalKeys']		= "Zezw�l na operatory logiczne przy bezpo�rednim wyborze";
...
$GLOBALS['strReverseLookup']			= "Spr�buj ustali� nazw� hosta odwiedzaj�cego, je�li nie zosta�a podana przez serwer";
$GLOBALS['strProxyLookup']			= "Spr�buj ustali� prawdziwy adres IP odwiedzaj�cego, je�li korzysta on z Proxy";
...
$GLOBALS['strBlockAdclicks']			= "Nie loguj Klikni�� je�li odwiedzaj�cy klikn�� w banner w ci�gu podanego w sekundach czasu";
