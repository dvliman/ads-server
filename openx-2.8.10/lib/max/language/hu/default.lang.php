...
$GLOBALS['strNoAdminInteface']			= "Az adminisztrációs felület jelenleg karbantartás miatt nem elérhető. A kampányok kiszolgálását ez nem akadályozza.";
...
$GLOBALS['strCollectedAll']			= "Minden összegyűjtött statisztika";
$GLOBALS['strCollectedToday']		= "Ma";
$GLOBALS['strCollected7Days']		= "Az utóbbi 7 nap statisztikája";
...
$GLOBALS['strViewsPurchased'] 			= "Visszalévő letöltés";
$GLOBALS['strClicksPurchased'] 			= "Visszalévő kattintás";
$GLOBALS['strCampaignWeight']			= "A kampány fontossága";
$GLOBALS['strHighPriority']			= "A kampány reklámainak megjelenítése magas prioritással.<br>Ennek a tulajdonságnak a használata esetén a phpAdsNew megpróbálja a nap folyamán egyenletesen elosztani a reklámletöltések számát.";
...
$GLOBALS['strAutoChangeHTML']			= "A HTML módosítása a kattintások nyomkövetésének engedélyezéséhez";
...
$GLOBALS['strContinent'] 				= "Földrész";
$GLOBALS['strUSState']					= "USA állam";
...
$GLOBALS['strTimeCapping']				= "Ugyanaz a felhasználó a továbbítás után nem láthatja a reklámot a következő időpontig:";
$GLOBALS['strImpressionCapping']		= "Ugyanannak a felhasználónak a reklám megjelenik:";
...
$GLOBALS['strBannerSelection']			= "Reklám kijelölése";
$GLOBALS['strCampaignSelection']		= "Kampány kijelölése";
...
$GLOBALS['strDistribution']			= "Megoszlás";
...
$GLOBALS['strHideInactiveOverview'] = "Inaktív elemek elrejtése az áttekintést szolgáló oldalakon";
$GLOBALS['strTimezoneInformation'] = "Időzona információk (Az időzona változtatása hatással van a statisztikákra)";
...
$GLOBALS['strVariable'] = "Változók";
$GLOBALS['strPreference'] = "Preferenciák";
$GLOBALS['str_ID'] = "Azonosító";
