...
$GLOBALS['strUserlog'][phpAds_actionAdvertiserReportMailed] = "Bericht für den Werbetreibenden {id} wurde per E-Mail versendet";
$GLOBALS['strUserlog'][phpAds_actionActiveCampaign] = "Kampagne {id} aktiviert";
$GLOBALS['strUserlog'][phpAds_actionAutoClean] = "Datenbank automatisch bereinigt";
$GLOBALS['strUserlog'][phpAds_actionBatchStatistics] = "Statistiken zusammengefaßt";
$GLOBALS['strUserlog'][phpAds_actionDeactivationMailed] = "Benachrichtigungsmail über die Deaktivierung der Kampagne {id} versendet";
$GLOBALS['strUserlog'][phpAds_actionDeactiveCampaign] = "Kampagne {id} deaktiviert";
$GLOBALS['strUserlog'][phpAds_actionPriorityCalculation] = "Neuberechnung der Prioritäten";
$GLOBALS['strUserlog'][phpAds_actionPublisherReportMailed] = "Auswertung für die Webseite {id} per E-Mail versendet";
$GLOBALS['strUserlog'][phpAds_actionWarningMailed] = "Deaktivierungswarnung für Kampagne {id} per E-Mail versandt";
