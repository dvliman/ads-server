...
$GLOBALS['strAlreadyInstalled']			= MAX_PRODUCT_NAME." ya se encuentra instalado en el sistema. Si desea configurarlo vaya a <a href='settings-index.php'>Configuración de Interface</a>";
...
$GLOBALS['strTableInUse']				= "La base de datos especificada ya se encuentra utilizada por ".MAX_PRODUCT_NAME.", por favor use un prefijo de tabla diferente, o lea el manual de instrucciones para actualizar.";
...
$GLOBALS['strWarningPHPversion']		= MAX_PRODUCT_NAME." requiere PHP 4.0 o mayor para funcionar correctamente. Ud. está usando {php_version}.";
...
$GLOBALS['strConfigLockedDetected']		= MAX_PRODUCT_NAME." ha detectado que su <b>config.inc.php</b> no tiene permiso de escritura por el server.<br /> Ud. no podrá proseguir si no cambia los permisos del archivo. <br />Lea la documentación suministrada si no sabe como hacerlo.";
...
$GLOBALS['strInstallMessage']			= "Antes de poder usar ".MAX_PRODUCT_NAME." necesitará configurarlo y <br /> deberá crear la base de datos. Clickee en <b>Proceder</b> para continuar.";
