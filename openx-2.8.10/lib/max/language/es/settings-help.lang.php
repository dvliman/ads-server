...
+---------------------------------------------------------------------------+
$Id: settings-help.lang.php 81772 2012-09-11 00:07:29Z chris.nutting $
*/

// Settings help translation strings
$GLOBALS['phpAds_hlp_dbhost'] = "\n        Especifique el nombre del host donde se encuentra la base de datos de ".$phpAds_dbmsname.".\n		";

$GLOBALS['phpAds_hlp_dbuser'] = "\n        Especifique el nombre de usuario con el cual ".MAX_PRODUCT_NAME." accederá a la base de datos ".$phpAds_dbmsname.".\n		";

$GLOBALS['phpAds_hlp_dbpassword'] = "\n        Especifique el password que usará ".MAX_PRODUCT_NAME." para acceder a la base de datos ".$phpAds_dbmsname.".\n		";

$GLOBALS['phpAds_hlp_dbname'] = "\n        Especifique el nombre de la base de datos donde ".MAX_PRODUCT_NAME." debe ingresar los datos.\n		";

$GLOBALS['phpAds_hlp_persistent_connections'] = "\n	El uso de conexiones persistentes puede acelerar el uso de ".MAX_PRODUCT_NAME." considerablemente\n	y posiblemente decremente la carga en el server. Sin embargo hay un inconveniente\; en sitios en los cuales\n	hay gran cantidad de visitantes, la carga en el servidor puede incrementar usando conexiones normales.\n	Ud. deberá decidir que tipo de conexión usar dependiendo de la cantidad de visitanes y el hardware que Ud. use.\n	Si ".MAX_PRODUCT_NAME." está usando demasiados recursos, deberá revisar esta configuración primero.\n		";

$GLOBALS['phpAds_hlp_compatibility_mode'] = "\n        Si está teniendo dificultades integrando ".MAX_PRODUCT_NAME." con otro producto de un tercero, tal vez le ayude habilitar\n		el modo de compatibilidad de base de datos. Si está usando el modo de invocación local y la compatibilidad de base de datos\n		se encuentra activada en ".MAX_PRODUCT_NAME." debe dejar el estado de conexión de la base de datos exactamente como se\n		encontraba antes de correr ".MAX_PRODUCT_NAME.".\n		Esta opción es un tanto mas lenta y por lo tanto deshabilitada por default.\n		";

$GLOBALS['phpAds_hlp_table_prefix'] = "\n        Si la base de datos ".MAX_PRODUCT_NAME." es usada o compartida por multiples softwares, es aconsejable agregar un prefijo al nombre de las tablas.\n		Si está usando multiples instalaciones de ".MAX_PRODUCT_NAME."\n		en la misma base de datos, deberá asegurarse que este prefijo sea único para todas las instalaciones.\n		";

$GLOBALS['phpAds_hlp_tabletype'] = "\n        ".$phpAds_dbmsname." soporta multiples tipos de tablas. Cada tipo de tabla tiene una propiedades únicas y algunas pueden acelerar ".MAX_PRODUCT_NAME."\n		considerablemente. MyISAM es el tipo predeterminado y se encuentra disponible en todas las instalaciones de ".$phpAds_dbmsname.". \n		Otro tipo de tablas tal vez no se encuentren disponibles en su servidor.\n		";

$GLOBALS['phpAds_hlp_url_prefix'] = "\n        ".MAX_PRODUCT_NAME." necesita saber donde se encuentra ubicado en el web server para \n        funcionar correctamente. Debe especificar la URL hacia el directorio donde ".MAX_PRODUCT_NAME."\n        se encuentra instalado, por ejemplo: http://www.su-sitio.com/".MAX_PRODUCT_NAME.".\n		";
...
$GLOBALS['phpAds_hlp_admin_email_headers'] = "\n        Puede alterar los encabezados de los e-mails enviados por ".MAX_PRODUCT_NAME.".\n		";
...
$GLOBALS['phpAds_hlp_updates_frequency'] = "\n        Si desea buscar nuevas versiones de ".MAX_PRODUCT_NAME." puede habilitar esta opción.\n        Es posible especificar el intervalo en que ".MAX_PRODUCT_NAME." se conecta al server de\n        actualizaciones. Si se encuentra una nueva versión, aparecerá un cuadro de diálogo con la\n        información de la actualización.\n		";

$GLOBALS['phpAds_hlp_userlog_email'] = "\n        Si desea mantener una copia de todos los e-mails enviados por ".MAX_PRODUCT_NAME." puede\n        activar esta opción. Los mensajes de e-mail serán almacenados en el userlog.\n		";
