...
$GLOBALS['strOpenadsIdSettings'] = "Настройки OpenX ID";
...
$GLOBALS['strCampaignNoRecords'] = "<li>Кампании позволяют группировать баннеры разных форматов, связанные по смыслу</li><li>При группировке баннеров в кампании отпадает необходимость настройки параметров для каждого баннера в отдельности</li><li>Подробности вы можете найти в <a class='site-link' target='help' href='". OX_PRODUCT_DOCSURL ."/inventory/advertisersAndCampaigns/campaigns'>Документации по кампаниям</a>!</li>";
...
$GLOBALS['strCampaignWarningExclusiveNoWeight'] = "Приоритет этой кампании был установлен на низком уровне,\nно вес был установлен равным нулю, или не был указан вовсе.\nЭто вызовет отключение кампании и баннеры не будут показываться до тех пор,\nпока не будет задан вес, отличный от нуля.\n\nВы действительно хотите продолжить?";
...
$GLOBALS['strDashboardGenericError'] = "Основная ошибка";
...
$GLOBALS['strDashboardErrorMsg800'] = "XML-RPC ошибка соединения";
$GLOBALS['strDashboardErrorMsg801'] = "Не авторизованы";
$GLOBALS['strDashboardErrorMsg802'] = "CAPTCHA неверна";
$GLOBALS['strDashboardErrorMsg803'] = "Неправильные параметры";
$GLOBALS['strDashboardErrorMsg804'] = "Имя пользователя не совпадает с платформой";
$GLOBALS['strDashboardErrorMsg805'] = "Платформы не существует";
$GLOBALS['strDashboardErrorMsg806'] = "Ошибка сервера";
$GLOBALS['strDashboardErrorMsg807'] = "Не уполномочен";
$GLOBALS['strDashboardErrorMsg808'] = "версия XML-RPC не поддерживается";
$GLOBALS['strDashboardErrorMsg900'] = "Код ошибка траспорта";
$GLOBALS['strDashboardErrorMsg821'] = "M2M ошибка аутентификации - такой тип учетной записи не допускается";
$GLOBALS['strDashboardErrorMsg822'] = "M2M ошибка аутентификации - пароль уже сгенерирован";
$GLOBALS['strDashboardErrorMsg823'] = "M2M ошибка аутентификации - неверный пароль";
$GLOBALS['strDashboardErrorMsg824'] = "M2M ошибка аутентификации - пароль закончился";
$GLOBALS['strDashboardErrorMsg825'] = "M2M ошибка аутентификации - не могу подключиться";
$GLOBALS['strDashboardErrorMsg826'] = "M2M ошибка аутентификации - не могут переконнектиться";
$GLOBALS['strDashboardErrorDsc800'] = "Панель инструментов получает информацию с центрального сервера для некоторых виджетов. Есть несколько вещей, которые могут повлиять на это.<br />На аашем сервере не установленно Curl extension. Вам, возможно, потребуется установить или включить Curl extension, см. <a href='http://php.net/curl'>здесь</a> для более подробной информации. <br />	Вы должны также проверить, что ваш брандмауэр не блокирует исходящие соединения.";
$GLOBALS['strDashboardErrorDsc803'] = "Ошибка в запросе к серверу - неправильные параметры, попробуйте передать ваши данные повторно";
$GLOBALS['strDashboardErrorDsc805'] = "XML-RPC соединение не было разрешено в ходе установки OpenX и центральный сервер OpenX не распознает вашей OpenX установки, как в верной.<br />	Перейдите в Администратративный вход, Мой аккаунт -> Product Updates для подключения и регистрации на центральном сервере.";
...
$GLOBALS['strEnableCookies'] = "Вам необходимо разрешить cookies для работы с  ". MAX_PRODUCT_NAME ."";
