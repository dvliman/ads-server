...
$GLOBALS['strAlreadyInstalled']			= "". MAX_PRODUCT_NAME ." уже установлен. Для его настройки перейдите в <a href='account-index.php'>раздел настроек</a>.";
...
$GLOBALS['strInstallWelcome']			= "Добро пожаловать в ". MAX_PRODUCT_NAME ." ";
...
$GLOBALS['strAdminEmailHeaders']		= "Добавлять в каждое письмо заголовок message sent by ". MAX_PRODUCT_NAME ."";
...
$GLOBALS['strInstallIntro'] = "Спасибо, что выбрали a href='http://". MAX_PRODUCT_URL ."' target='_blank'><strong>". MAX_PRODUCT_NAME ."</strong></a><p>Этот мастер поможет вам установить или обновить существующий сервер ". MAX_PRODUCT_NAME .".</p><p>Чтобы помочь вам разобраться в процессе инсталляции,  мы создали <a href='". OX_PRODUCT_DOCSURL ."/wizard/qsg-install' target='_blank'>Руководство по быстрому старту</a>. Для более детальной информации об установке и конфигурировании ". MAX_PRODUCT_NAME ." обратитесь к <a href='". OX_PRODUCT_DOCSURL ."/wizard/admin-guide' target='_blank'>Руководству администратора</a>.";
...
$GLOBALS['strDbUpgradeIntro'] = "Ниже указаны данные для подключения к БД текущей инсталляции ". MAX_PRODUCT_NAME .". проверьте их, пожалуйста. Когда вы нажмете кнопку \"продолжить\"";
...
$GLOBALS['strDbSuccessIntro'] = "Была создана БД для ". MAX_PRODUCT_NAME .". Нажмите кнопку \"Продолжить\" для конфигурирования настроек администрирования и доставки баннеров.";
...
$GLOBALS['strDemoDataIntro'] = "В БД ". MAX_PRODUCT_NAME ." могут быть проинсталлированы демо-данные, для того, чтобы помочь вам освоится с программой. Будут загружены и настроены основные типы баннеров, а также несколько демо-кампаний. Мы очень рекомендуем использовать демо-данные для новых инсталляций.";
...
$GLOBALS['strWebPath'] = "Глобальные пути доступа сервера ". MAX_PRODUCT_NAME ."";
...
$GLOBALS['strTermsIntro'] = "". MAX_PRODUCT_NAME ." распространяется под открытой лицензией GNU General Public Licence. Пожалуйста, прочтите и согласитесь с нижеследующим документом для продолжения инсталляции.";
