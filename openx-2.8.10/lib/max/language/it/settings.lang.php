...
$GLOBALS['strUpdateDatabaseError']			= "Per motivi sconosciuti l'aggiornamento del database non è andato a buon fine. È consigliato cliccare su <b>Riprova</b> per tentare di correggere questi potenziali problemi. Se sei sicuro che questi errori non influiscano sul corretto funzionamento di ".MAX_PRODUCT_NAME." clicca su <b>Ignora errori</b> per continuare. Ignorare questi errori può causare seri problemi e non è consigliato!";
$GLOBALS['strAlreadyInstalled']				= MAX_PRODUCT_NAME." è già installato su questo sistema. Per modificare le impostazioni clicca <a href='settings-index.php'>qui</a>";
...
$GLOBALS['strTableInUse']					= "Il database specificato è già utilizzato da ".MAX_PRODUCT_NAME.", utilizza un diverso prefisso per le tabelle, o leggi il manuale le istruzioni sull'aggiornamento.";
...
$GLOBALS['strFixProblemsBefore']			= "Le seguenti cose devono essere corrette prima di installare ".MAX_PRODUCT_NAME.". Per qulunque dubbio su questi messaggi di errore, consultare la <i>Administrator guide</i>, presente nell'archivio scaricato.";
$GLOBALS['strFixProblemsAfter']				= "Se non sei in grado di risolvere i problemi elencati, ocntatta l'amministratore del sistema su cui stai installando ".MAX_PRODUCT_NAME.". L'amministratore del server potrebbe essere in grado di aiutarti.";
...
$GLOBALS['strWarningPHPversion']			= MAX_PRODUCT_NAME." richiede PHP 4.0 o più recente per funzionare correttamente. La versione attualmente utilizzata è {php_version}.";
...
$GLOBALS['strConfigLockedDetected']			= "Il file <b>config.inc.php</b> non può essere sovrascritto dal server. Non � possiblie procedere finché non vengono modificati i permessi sul file. Puoi leggere sul manuale di ".MAX_PRODUCT_NAME." come fare.";
...
$GLOBALS['strInstallMessage']				= "Prima di utilizzare ".MAX_PRODUCT_NAME." è necessario configurarlo e <br /> il database deve essere creato. Clicca su <b>Procedi</b> per continuare.";
...
$GLOBALS['strAdminEmailHeaders']			= "Aggiungi i seguenti header ad ogni e-mail inviata da ".MAX_PRODUCT_NAME;
