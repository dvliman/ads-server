...
$GLOBALS['strPluginAffiliate'] 		= "Genera un resoconto per l'editore selezionato. Il rapporto sarà esportato in formato CSV per l'utilizzo in un foglio elettronico.";
$GLOBALS['strPluginCampaign'] 		= "Genera un resoconto per la campagna selezionata. Il rapporto sarà esportato in formato CSV per l'utilizzo in un foglio elettronico.";
$GLOBALS['strPluginClient'] 		= "Genera un resoconto per l'inserzionista selezionato. Il rapporto sarà esportato in formato CSV per l'utilizzo in un foglio elettronico.";
