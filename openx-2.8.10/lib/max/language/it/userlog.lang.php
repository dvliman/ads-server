...
$GLOBALS['strUserlog'][phpAds_actionAdvertiserReportMailed] = "Rapporto per inserzionista {id} spedito via email";
$GLOBALS['strUserlog'][phpAds_actionPublisherReportMailed] = "Rapporto per editore {id} spedito via email";
$GLOBALS['strUserlog'][phpAds_actionWarningMailed] = "Messaggio di avvertimento per la disattivazione della campagna {id} spedita tramite email";
$GLOBALS['strUserlog'][phpAds_actionDeactivationMailed] = "Notifica disattivazione per campagna {id} spedito via email";
$GLOBALS['strUserlog'][phpAds_actionPriorityCalculation] = "Priorità ricalcolata";
$GLOBALS['strUserlog'][phpAds_actionPriorityAutoTargeting] = "Limiti giornalieri ricalcolati";
